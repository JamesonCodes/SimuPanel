    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-20 bg-gray-50 rounded-lg p-8 border border-gray-200"
        >
          <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">
            How Teams Use SimuPanel
          </h3>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Product Validation</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Creative Testing</h4>
              <p className="text-sm text-gray-600">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Validate your concept with synthetic consumer data — in minutes.
          </p>
